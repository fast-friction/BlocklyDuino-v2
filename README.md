...
### Main UI Changes (index.html)
* **Lines 16-47:** Added mandatory style definitions for the bitmap editor.
* **Line 332:** Added `<option value="citera_board">citera_board</option>` to the `boardMenu`.
* **Line 543:** Added `<option value="citera_board">citera_board</option>` to the `boardDescriptionSelector`.
...
* **`tools/blockFactory/codeFactory.js`**
* **`@blockly/demos/code/code.js`**
  * Changed the default initial language to Japanese (`ja`).

### New Board Support: Citera Board
* **`blocklyduino/arduino/board/citera.js`**
* **`blocklyduino/blocks/board/citera.js`**
  * Added `citera.js`, created based on `board_base.js`.
  * Added and adjusted blocks specifically for the Citera board.
* **`blocklyduino/js/boards.json`**
...
* **`blocklyduino/arduino/typed_variable.js`**
* **`blocklyduino/blocks/typed_variable.js`**
* **`js/typed_variable.js`**
